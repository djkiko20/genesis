...
if($_POST)
{
    ...
    $sql="insert into tbl_komentari_profesori (profesorID,datum,lajk,dislajk,faktor,tekst) values('$profesorID','$datum','$lajk','$dislajk','$faktor','$komentar')";
    if($conn->exec($sql))
    {
