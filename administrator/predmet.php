...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="js/jquery.tokeninput.profesori.js"></script>
            ...
            <div id="contentwrapper">
                <div class="main_content">
                    ...
                    <div id="jCrumbs" class="breadCrumb module">
                        <h4>Додади предмет</h4>
                    </div>

                    <form action="skripti/add_predmet.php" method="post" enctype="multipart/form-data">
                        <div class="formSep">
                            <div id="responsecontainer">
                                <?php
                                if($_GET['success'] == 1){
                                    echo '<p style="color: green;">Успешно е додаден предмет!</p>';
                                } else if($_GET['success'] == 2){
                                    echo '<p style="color: red;">Неуспешно додавање на предмет!</p>';
                                }
                                ?>
                            </div>
                            <label>Назив</label>
                            <input type="text" name="nazivP">
                            <label>Опис</label>
                            <textarea name="opis" id="opis" cols="10" rows="10"></textarea>
                            <label>Факултети</label>
                                <input type="text" id="demo-input" name="fakulteti" />
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        $("#demo-input").tokenInput("skripti/lista_auto_complete_fakulteti.php" , {tokenLimit: 1});
                                    });
                                </script>
                            <label>Професори</label>
                            <input type="text" id="demo-input1" name="profesori" />
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    $("#demo-input1").tokenInput("skripti/lista_auto_complete_profesori.php");
                                });
                            </script>
                            <label>Детален опис (.pdf)</label>
                            <input id="fajl" type="file" name="fajl">
