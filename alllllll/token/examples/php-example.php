...
mysql_select_db("cordova") or die("Could not select database");

# Perform the query
$query = sprintf("SELECT id, name from tbl_zapisi WHERE name LIKE '%%%s%%' LIMIT 10", mysql_real_escape_string($_GET["q"]));
$arr = array();
