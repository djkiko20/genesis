...
$result=mysql_query("select * from tbl_komentari_profesori where komentarID >".$getLastContentId." order by faktor desc limit 5");
...
while($row=mysql_fetch_array($result)) {
    ...
    echo "<input type='hidden' value='".$row['komentarID']."' />";
